...
\textbf{Explication de la figure :} cette page permet à l'utilisateur de se
...
\textbf{Explication de la figure :} cette interface permet de créer un nouveau
...
\textbf{Explication de la figure :} l'écran d'accueil présente le catalogue
...
\textbf{Explication de la figure :} cette capture montre le résultat d'une
...
\textbf{Explication de la figure :} le message confirme que le lien de partage
...
\textbf{Explication de la figure :} cette page regroupe les titres sauvegardés
...
\textbf{Explication de la figure :} l'écran des playlists permet d'organiser
...
\textbf{Explication de la figure :} cette page permet de modifier les
...
\textbf{Explication de la figure :} cette interface est réservée aux comptes
...
\textbf{Explication de la figure :} Swagger UI présente automatiquement la
